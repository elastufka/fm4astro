...
#SBATCH --error sbatch_logs/extract_feats_HF-error.e%j     # optional. By default a file slurm-{jobid}.out will be created
#SBATCH --output sbatch_logs/extract_feats_HF-out.o%j      # optional. By default the error and output files are merged
