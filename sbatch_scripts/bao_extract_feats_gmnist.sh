#!/bin/sh
#SBATCH --job-name extract_feats_GMNIST            # this is a parameter to help you sort your job when listing it
...
data_path=/home/users/l/lastufka/scratch/MiraBest #/home/users/l/lastufka/scratch/RadioGalaxyNET
dname=MiraBest #RGN

if [ ! -f /home/users/l/lastufka/FM_compare/"$dname"_testfeat_dinov2B.pth ]; then
    srun python /home/users/l/lastufka/FM_compare/extract_features.py --dataset_train $data_path --test --img_fmt PIL
...
if [ ! -f /home/users/l/lastufka/FM_compare/"$dname"_trainfeat_dinov2B.pth ]; then
    srun python /home/users/l/lastufka/FM_compare/extract_features.py --dataset_train $data_path --img_fmt PIL
...
if [ ! -f /home/users/l/lastufka/FM_compare/"$dname"_trainfeat_maeB.pth ]; then
    srun python /home/users/l/lastufka/FM_compare/extract_features.py --dataset_train $data_path --model facebook/vit-mae-base --img_fmt PIL
...
if [ ! -f /home/users/l/lastufka/FM_compare/"$dname"_testfeat_maeB.pth ]; then 
    srun python /home/users/l/lastufka/FM_compare/extract_features.py --dataset_train  $data_path --model facebook/vit-mae-base --test --img_fmt PIL
...
if [ ! -f /home/users/l/lastufka/FM_compare/"$dname"_trainfeat_msnB.pth ]; then
    srun python /home/users/l/lastufka/FM_compare/extract_features.py --dataset_train  $data_path --model facebook/vit-msn-base --img_fmt PIL
...
if [ ! -f /home/users/l/lastufka/FM_compare/"$dname"_testfeat_msnB.pth ]; then
    srun python /home/users/l/lastufka/FM_compare/extract_features.py --dataset_train $data_path --model facebook/vit-msn-base --test --img_fmt PIL
...
#     srun python /home/users/l/lastufka/FM_compare/extract_features.py --dataset_train $data_path --model microsoft/resnet-152 --test --img_fmt PIL
#     mv /home/users/l/lastufka/FM_compare/features.pth /home/users/l/lastufka/FM_compare/"$dname"_testfeat_RN152.pth
# fi

# if [ ! -f /home/users/l/lastufka/FM_compare/"$dname"_trainfeat_msnB4.pth ]; then
...
# if [ ! -f /home/users/l/lastufka/FM_compare/"$dname"_testfeat_msnB4.pth ]; then
