...
#SBATCH --error /home/users/l/lastufka/sbatch_logs/mgcls_frcnn_mae-error.e%j     # optional. By default a file slurm-{jobid}.out will be created
#SBATCH --output /home/users/l/lastufka/sbatch_logs/mgcls_frcnn_mae-out.o%j      # optional. By default the error and output files are merged
...
##SBATCH --exclude=gpu002,gpu017,gpu046,gpu047,gpu026,gpu021
...
# srun python /home/users/l/lastufka/fastercnn-pytorch-training-pipeline/train_frcnn.py --data $data --epochs 100 --model fasterrcnn_vitdet --batch 8 -ims $imsize -uta --name mgcls_vit_det_mae_finetune_30p --mosaic 0 --weights /home/users/l/lastufka/outputs/training/mgcls_vit_det_mae_finetune_30p/last_model.pth --resume 

data=/home/users/l/lastufka/scratch/MGCLS_data/enhanced/test_data_prep_cs/rcnn_dataset_50p.yaml

srun python /home/users/l/lastufka/fastercnn-pytorch-training-pipeline/train_frcnn.py --data $data --epochs 100 --model fasterrcnn_vitdet --batch 8 -ims $imsize -uta --name mgcls_vit_det_mae_finetune_50p --mosaic 0 --weights /home/users/l/lastufka/FM_compare/facebook_vit_mae_base_statedict.pth #--freeze 12 --resume

#/home/users/l/lastufka/outputs/training/mgcls_vit_det_msn_finetune_50p/last_model.pth --resume #/home/users/l/lastufka/outputs/training/mgcls_vit_det_msn_finetune_50p --resume #--freeze 12